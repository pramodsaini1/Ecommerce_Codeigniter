...
<section class="tp-login-area pb-140 p-relative z-index-1 fix">
   <div class="tp-login-shape">
      <img class="tp-login-shape-1" src="<?=base_url()?>main_assets/img/login/login-shape-1.png" alt="">
      <img class="tp-login-shape-2" src="<?=base_url()?>main_assets/img/login/login-shape-2.png" alt="">
      <img class="tp-login-shape-3" src="<?=base_url()?>main_assets/img/login/login-shape-3.png" alt="">
      <img class="tp-login-shape-4" src="<?=base_url()?>main_assets/img/login/login-shape-4.png" alt="">
   </div>
   <?=form_open_multipart("Dashboard/create_account")?>
     <div class="container">
            ...
            <div class="tp-login-wrapper">
                <div class="col-sm-12">
                    <?php
                     if($this->session->flashdata("insertMsg")){
                        ?>
                           <div class="alert alert-success"><?=$this->session->flashdata("insertMsg")?></div>
                        <?php
                     }
                     else if($this->session->flashdata("againMsg")){
                        ?>
                           <div class="alert alert-success"><?=$this->session->flashdata("againMsg")?></div>
                        <?php
                     }
                     else if($this->session->flashdata("errorImage")){
                        ?>
                           <div class="alert alert-success"><?=$this->session->flashdata("errorImage")?></div>
                        <?php
                     }
                    ?>
                </div>
               <div class="tp-login-top text-center mb-30">
                   <p>Already have an account?  <span><a href="<?=base_url()."Dashboard/login"?>">Sign In</a></span></p>
               </div>
               ...
               <div class="tp-login-option">
                  ...
                  <div class="tp-login-input-wrapper">
                     ...
                     <div class="tp-login-input-box">
                        <div class="tp-login-input">
                           <input id="phone" name="phone" type="number" placeholder="Enter Phone Number">
                        </div>
                        <div class="tp-login-input-title">
