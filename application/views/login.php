...
<section class="tp-login-area pb-140 p-relative z-index-1 fix">
   ...
   <?=form_open_multipart("Dashboard/login_account")?>
   <div class="container">
      <div class="row justify-content-center">
         
         <div class="col-xl-6 col-lg-8">
         <?php
           if($this->session->flashdata("passErr")){
            ?>
             <div class="alert alert-danger"><?=$this->session->userdata("passErr")?></div>
            <?php
           }
        ?>
            <div class="tp-login-wrapper">
            <div class="tp-login-top text-center mb-30">
                            <p>Don’t have an account? <span><a href="<?=base_url()."Dashboard/register"?>">Create a free account</a></span></p>
            </div>
