                     ...
                     <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list has-icon">
                           ...
                           <?php
                                 ...
                                 $this->db->where("category_id",$rep->category);
                  ...
                  <div class="row">
                           ...
                           <div class="tab-content m-img" id="productDetailsNavContent">
                              <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                                 <div class="tp-product-details-nav-main-thumb">
                                    <img src="<?=base_url()?>./<?php echo $rep->product_main_image?>" alt="">
                                 </div>
                              </div>
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <h3 class="tp-product-details-title"><?=$rep->product_name?></h3>
                           ...
                           <div class="tp-product-details-price-wrapper mb-20">
                              <span class="tp-product-details-price old-price">₹<?=number_format($rep->product_mrp,2)?></span>
                              <span class="tp-product-details-price new-price">₹<?=number_format($rep->product_selling_price,2)?></span>
                           </div>
   
                            
   
                           <!-- actions -->
                           <?=form_open("Dashboard/add_to_cart")?>
                              ...
                              <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                 <div class="tp-product-details-quantity">
                                    <div class="tp-product-quantity mb-15 mr-15">
                                       ...
                                       <input class="tp-cart-input" type="text" name="product_quantity" value="1">
                                 ...
                                 <div class="tp-product-details-add-to-cart mb-15 w-100">
                                    <input type="text" name="product_id" value="<?=$rep->p_id?>" hidden>
                                 <button type="submit" class="tp-product-details-buy-now-btn w-100">Add To Cart</button>
                                 </div>
                              </div>
                           ...
                           <input type="text" id="p_id" name="product_id" value="<?=$rep->p_id?>" hidden>
                            <div class="tp-product-details-action-sm">
                              
                              <button type="submit" class="tp-product-details-action-sm-btn wish">
                                 ...
                                 <span id="content">Add Wishlist</span>
                                 </button>
      ...
      <script>
         $(document).ready(function(){
            $(".wish").click(function(){
               ...
               $.ajax({
                 url:"<?=base_url()."Dashboard/wishlist"?>",
                 type:"POST",
                 data:{product_id:product_id},
                 success:function(data){
                     if(data=="login"){
                     document.getElementById("content").innerHTML="Please Login";
                    }
                    else if(data=="success"){
                         document.getElementById("content").innerHTML="Wishlist Added Successfully";
                    }
                    else if(data=="again"){
                         document.getElementById("content").innerHTML="Wishlist Already Added ";
                    }
                 }
               });
             });
