               ...
               <div class="tp-contact-info-wrapper">
                  <div class="tp-contact-info-item">
                     <div class="tp-contact-info-icon">
                        <span>
                           <img src="<?=base_url()?>main_assets/img/contact/contact-icon-1.png" alt="">
                        </span>
                     </div>
                  ...
                  <div class="tp-contact-info-item">
                     <div class="tp-contact-info-icon">
                        <span>
                           <img src="<?=base_url()?>main_assets/img/contact/contact-icon-2.png" alt="">
                        </span>
                     </div>
                     <div class="tp-contact-info-content">
                        <p>
                  ...
                  <div class="tp-contact-info-item">
                     <div class="tp-contact-info-icon">
                        <span>
                           <img src="<?=base_url()?>main_assets/img/contact/contact-icon-3.png" alt="">
                        </span>
                     </div>
                     <div class="tp-contact-info-content">
